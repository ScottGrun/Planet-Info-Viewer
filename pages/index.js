...
export default function Home({ planet }) {
  ...
  return (
    <>
    <MobileInfoSection sectionDisplayed={sectionDisplayed} setSectionDisplayed={setSectionDisplayed}/>
    <Wrapper>
    <MobileSectionToggler>
    </MobileSectionToggler>

      <ImgContainer>
        <PlanetImgContainer imgSrc={planet.images.planet} sizes={planet.sizes} />
      </ImgContainer>
  
      <DescriptionContainer>
        <PlanetDescription sectionDisplayed={sectionDisplayed} setSectionDisplayed={setSectionDisplayed} overview={planet.overview.content} overviewSrc={planet.overview.source} structure={planet.structure.content} structureSrc={planet.structure.source} geology={planet.geology.content} geologySrc={planet.geology.source} />
      </DescriptionContainer>
  
      <StatsContainer>
        <PlanetStatsContainer rotation={planet.rotation} revolution={planet.revolution} radius={planet.radius} temperature={planet.temperature}/>
      </StatsContainer>
    </Wrapper>
    </>
  )
...
export async function getStaticProps(context) {
  const res = await fetch(`http://localhost:3000/api/planets/Earth`)
